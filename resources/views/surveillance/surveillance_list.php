...
(function () {
    ...
    function updateRows() {
        ...
        if (pageNumbers) {
            ...
            pushPage(1);
            for (var candidatePage = currentPage - 1; candidatePage <= currentPage + 1; candidatePage += 1) {
                pushPage(candidatePage);
            }
            pushPage(totalPages);
