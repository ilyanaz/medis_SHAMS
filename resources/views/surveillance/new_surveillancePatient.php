...
<label class="field">NRIC <input id="employee_NRIC" name="employee_NRIC" type="text" value="<?php echo $esc(old('employee_NRIC')); ?>" placeholder="Enter NRIC"></label>
<label class="field">Passport No <input id="employee_passportNo" name="employee_passportNo" type="text" value="<?php echo $esc(old('employee_passportNo')); ?>" placeholder="Enter passport number"></label>
<label class="field">Date of Birth <input name="employee_DOB" type="date" value="<?php echo $esc(old('employee_DOB')); ?>"></label>
<label class="field">Gender <select name="employee_gender"><option value="">Select</option><option value="Male"<?php echo old('employee_gender') === 'Male' ? ' selected' : ''; ?>>Male</option><option value="Female"<?php echo old('employee_gender') === 'Female' ? ' selected' : ''; ?>>Female</option></select></label>
<label class="field full">
<span class="field-label-row"><span>Address</span><?php if ($hasSelectedCompany): ?><span class="checkbox-inline"><input type="checkbox" id="sameCompanyAddress"> Same as company address</span><?php endif; ?></span>
<input id="employee_address" name="employee_address" type="text" value="<?php echo $esc(old('employee_address')); ?>" placeholder="Enter address"></label>
<label class="field">Postcode <input id="employee_postcode" name="employee_postcode" type="text" value="<?php echo $esc(old('employee_postcode')); ?>" placeholder="Enter postcode" pattern="^[0-9]{4,10}$"></label>
<label class="field">District <input id="employee_district" name="employee_district" type="text" value="<?php echo $esc(old('employee_district')); ?>" placeholder="Enter district"></label>
<label class="field">State <input id="employee_state" name="employee_state" type="text" value="<?php echo $esc(old('employee_state')); ?>" placeholder="Enter state"></label>
<label class="field">Telephone <div class="phone-group"><select name="employee_phone_code"><option value="">Code</option><?php foreach ($countryCodes as $country): $code = (string) ($country['code'] ?? '+60'); ?><option value="<?php echo $esc($code); ?>"<?php echo old('employee_phone_code', '+60') === $code ? ' selected' : ''; ?>><?php echo $esc($code); ?></option><?php endforeach; ?></select><input name="employee_telephone" type="tel" value="<?php echo $esc(old('employee_telephone')); ?>" inputmode="numeric" placeholder="Phone number" pattern="^[0-9]{7,12}$"></div></label>
<label class="field">Email <input name="employee_email" type="email" value="<?php echo $esc(old('employee_email')); ?>" placeholder="Enter email"></label>
<label class="field">Ethnicity <select name="employee_ethnicity" id="employee_ethnicity"><option value="">Select</option><?php foreach(['Malay','Chinese','Indian','Orang Asli','Others'] as $option): ?><option value="<?php echo $esc($option); ?>"<?php echo old('employee_ethnicity') === $option ? ' selected' : ''; ?>><?php echo $esc($option); ?></option><?php endforeach; ?></select></label>
<label class="field hidden" id="employee_ethnicity_other_wrap">Ethnicity (Please justify) <textarea id="employee_ethnicity_other" name="employee_ethnicity_other" placeholder="Write your justification"><?php echo $esc(old('employee_ethnicity_other')); ?></textarea></label>
<label class="field">Citizenship <select name="employee_citizenship" id="employee_citizenship"><option value="">Select</option><?php foreach(['Malaysian Citizen','Others'] as $option): ?><option value="<?php echo $esc($option); ?>"<?php echo old('employee_citizenship') === $option ? ' selected' : ''; ?>><?php echo $esc($option); ?></option><?php endforeach; ?></select></label>
<label class="field hidden" id="employee_citizenship_other_wrap">Citizenship (Please justify) <textarea id="employee_citizenship_other" name="employee_citizenship_other" placeholder="Write your justification"><?php echo $esc(old('employee_citizenship_other')); ?></textarea></label>
...
<label class="field hidden" id="employee_martial_other_wrap">Marital Status (Please justify) <textarea id="employee_martial_other" name="employee_martial_other" placeholder="Write your justification"><?php echo $esc(old('employee_martial_other')); ?></textarea></label>
<label class="field" id="no_of_children_wrap">No. of Children <input id="no_of_children" name="no_of_children" type="number" min="0" value="<?php echo $esc(old('no_of_children')); ?>" placeholder="Enter number of children"></label>
<label class="field" id="years_married_wrap">Years Married <input id="years_married" name="years_married" type="number" min="0" value="<?php echo $esc(old('years_married')); ?>" placeholder="Enter years married"></label>
</div>
</div>
...
<div class="grid">
<label class="field full">Diagnosed History <textarea name="diagnosed_history" placeholder="Insert diagnosed history"><?php echo $esc(old('diagnosed_history')); ?></textarea></label>
<label class="field full">Medication History <textarea name="medication_history" placeholder="Insert medication history"><?php echo $esc(old('medication_history')); ?></textarea></label>
<label class="field full">Admitted History <textarea name="admitted_history" placeholder="Insert admitted history"><?php echo $esc(old('admitted_history')); ?></textarea></label>
<label class="field full">Family History <textarea name="family_history" placeholder="Insert family history"><?php echo $esc(old('family_history')); ?></textarea></label>
<label class="field full">Other History <textarea name="others_history" placeholder="Insert other history"><?php echo $esc(old('others_history')); ?></textarea></label>
</div>
</div>
...
<div class="grid">
<label class="field">Job Title <input type="text" name="current_job_title" value="<?php echo $esc(old('current_job_title')); ?>" placeholder="Enter current job title"></label>
<label class="field">Company Name <input type="text" name="current_company_name" value="<?php echo $esc($selectedCompanyName); ?>" placeholder="Enter current company name" <?php echo $hasSelectedCompany ? 'readonly' : ''; ?>></label>
<label class="field">Employment Duration <input type="text" name="current_employment_duration" value="<?php echo $esc(old('current_employment_duration')); ?>" placeholder="Enter employment duration"></label>
<label class="field">Chemical Exposure Duration <input type="text" name="current_chemical_exposure_duration" value="<?php echo $esc(old('current_chemical_exposure_duration')); ?>" placeholder="Enter exposure duration"></label>
<label class="field full">Chemical Exposure Incidents <textarea name="current_chemical_exposure_incidents" placeholder="Insert chemical exposure incidents"><?php echo $esc(old('current_chemical_exposure_incidents')); ?></textarea></label>
</div>
</div>
...
<label class="history-radio"><input type="radio" name="smoking_history" value="Current"<?php echo old('smoking_history') === 'Current' ? ' checked' : ''; ?>>Current</label>
...
<label class="field history-field" id="years_of_smoking_wrap">Years of Smoking <input type="number" min="0" name="years_of_smoking" value="<?php echo $esc(old('years_of_smoking')); ?>" placeholder="Enter years"></label>
<label class="field history-field" id="no_of_cigarettes_wrap">No. of Cigarettes <input type="number" min="0" name="no_of_cigarettes" value="<?php echo $esc(old('no_of_cigarettes')); ?>" placeholder="Enter count"></label>
</div>
...
<label class="history-radio"><input type="radio" name="vaping_history" value="Yes"<?php echo old('vaping_history') === 'Yes' ? ' checked' : ''; ?>>Yes</label>
<label class="history-radio"><input type="radio" name="vaping_history" value="No"<?php echo old('vaping_history') === 'No' ? ' checked' : ''; ?>>No</label>
</div>
</div>
<label class="field history-field" id="years_of_vaping_wrap">Years of Vaping <input type="number" min="0" name="years_of_vaping" value="<?php echo $esc(old('years_of_vaping')); ?>" placeholder="Enter years"></label>
</div>
<label class="field full">Hobby <textarea name="hobby" placeholder="Insert hobby details"><?php echo $esc(old('hobby')); ?></textarea></label>
</div>
</div>
...
<td><div class="training-radio-group"><label class="training-radio"><input type="radio" name="handling_of_chemical" value="Yes"<?php echo old('handling_of_chemical') === 'Yes' ? ' checked' : ''; ?>>Yes</label><label class="training-radio"><input type="radio" name="handling_of_chemical" value="No"<?php echo old('handling_of_chemical') === 'No' ? ' checked' : ''; ?>>No</label></div></td>
<td class="comment-field"><textarea name="chemical_comments" placeholder="Insert handling comments"><?php echo $esc(old('chemical_comments')); ?></textarea></td>
</tr>
<tr>
<th>Sign &amp; Symptoms Knowledge</th>
<td><div class="training-radio-group"><label class="training-radio"><input type="radio" name="sign_symptoms" value="Yes"<?php echo old('sign_symptoms') === 'Yes' ? ' checked' : ''; ?>>Yes</label><label class="training-radio"><input type="radio" name="sign_symptoms" value="No"<?php echo old('sign_symptoms') === 'No' ? ' checked' : ''; ?>>No</label></div></td>
<td class="comment-field"><textarea name="sign_comments" placeholder="Insert sign and symptoms comments"><?php echo $esc(old('sign_comments')); ?></textarea></td>
</tr>
<tr>
<th>Chemical Poisoning Knowledge</th>
<td><div class="training-radio-group"><label class="training-radio"><input type="radio" name="chemical_poisoning" value="Yes"<?php echo old('chemical_poisoning') === 'Yes' ? ' checked' : ''; ?>>Yes</label><label class="training-radio"><input type="radio" name="chemical_poisoning" value="No"<?php echo old('chemical_poisoning') === 'No' ? ' checked' : ''; ?>>No</label></div></td>
<td class="comment-field"><textarea name="poisoning_comments" placeholder="Insert poisoning comments"><?php echo $esc(old('poisoning_comments')); ?></textarea></td>
</tr>
<tr>
<th>Proper PPE Knowledge</th>
<td><div class="training-radio-group"><label class="training-radio"><input type="radio" name="proper_PPE" value="Yes"<?php echo old('proper_PPE') === 'Yes' ? ' checked' : ''; ?>>Yes</label><label class="training-radio"><input type="radio" name="proper_PPE" value="No"<?php echo old('proper_PPE') === 'No' ? ' checked' : ''; ?>>No</label></div></td>
<td class="comment-field"><textarea name="proper_comments" placeholder="Insert proper PPE comments"><?php echo $esc(old('proper_comments')); ?></textarea></td>
</tr>
<tr>
<th>PPE Usage</th>
<td><div class="training-radio-group"><label class="training-radio"><input type="radio" name="PPE_usage" value="Yes"<?php echo old('PPE_usage') === 'Yes' ? ' checked' : ''; ?>>Yes</label><label class="training-radio"><input type="radio" name="PPE_usage" value="No"<?php echo old('PPE_usage') === 'No' ? ' checked' : ''; ?>>No</label></div></td>
<td class="comment-field"><textarea name="usage_comments" placeholder="Insert PPE usage comments"><?php echo $esc(old('usage_comments')); ?></textarea></td>
</tr>
</tbody>
</table>
</div>
...
const setupOthers=function(selectId,wrapId,inputId){const select=document.getElementById(selectId);const wrap=document.getElementById(wrapId);const input=document.getElementById(inputId);const sync=function(){const isOther=select.value==='Others';wrap.classList.toggle('hidden',!isOther);input.required=false;if(!isOther){input.value='';}};select.addEventListener('change',sync);sync();};
...
const syncIdRequirement=function(){nric.setCustomValidity('');passport.setCustomValidity('');};
const syncMarital=function(){const isSingle=marital.value==='Single';const hasMaritalValue=marital.value!=='';children.required=false;years.required=false;childrenWrap.classList.toggle('hidden',isSingle||!hasMaritalValue);yearsWrap.classList.toggle('hidden',isSingle||!hasMaritalValue);if(isSingle||!hasMaritalValue){children.value='';years.value='';children.setCustomValidity('');years.setCustomValidity('');}};
