...
?>
<style>
    .content{min-height:clamp(640px,calc(100dvh - 250px),940px);display:flex;flex-direction:column}
    ...
    @media(max-width:760px){.content{min-height:auto}.toolbar input{min-width:100%}.bottom{align-items:flex-start;flex-direction:column}}
</style>
