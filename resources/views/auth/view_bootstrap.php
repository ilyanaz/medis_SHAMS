...
if (!function_exists('route')) {
    function route($name, $parameters = [])
    {
        $routes = [
            ...
            'panel.company_list' => '../company/company_list.php',
            'panel.company_new' => '../company/new_company.php',
            'panel.company_setup' => '../company/company_setup.php',
            ...
            'surveillance.patient' => '../surveillance/surveillance_patient.php',
            'surveillance.patient.new' => '../surveillance/new_surveillancePatient.php',
            'surveillance.patient.view' => '../surveillance/survPatient_view.php',
            'surveillance.patient.edit' => '../surveillance/survPatient_edit.php',
            'surveillance.patient.update' => '../surveillance/survPatient_edit.php',
            'surveillance.patient.delete' => '../surveillance/survPatient_delete.php',
            'surveillance.patient.destroy' => '../surveillance/survPatient_delete.php',
            'surveillance.employee' => '../surveillance/surveillance_patient.php',
            'surveillance.employee.new' => 'new_employee.php',
            'surveillance.employee.store' => 'new_employee.php',
            'surveillance.employee.edit' => '../surveillance/survPatient_edit.php',
            'surveillance.employee.update' => '../surveillance/survPatient_edit.php',
            'surveillance.employee.delete' => '../surveillance/survPatient_delete.php',
            ...
            'surveillance.declaration' => '../surveillance/surveillance_declaration.php',
            'surveillance.declaration.save' => '../surveillance/surveillance_declaration.php',
            ...
            'audiometry.employee' => '../audiometry/audiometry_employee.php',
