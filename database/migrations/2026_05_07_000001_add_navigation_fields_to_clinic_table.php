    ...
    public function up(): void
    {
        ...
        Schema::table('clinic', function (Blueprint $table) {
            if (! Schema::hasColumn('clinic', 'clinic_registration')) {
                $table->string('clinic_registration', 100)->nullable()->after('clinic_password');
            }

            if (! Schema::hasColumn('clinic', 'clinic_header_path')) {
                $table->string('clinic_header_path')->nullable()->after('clinic_registration');
            }
